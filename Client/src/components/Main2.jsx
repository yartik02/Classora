  ...
  const gridMap = [
    {
      ...
      color: theme === "dark" ? "#5252dbff" : "#3838ff",
    ...
    },
    {
      ...
      color: theme === "dark" ? "#e23838de" : "#f10000de",
      name: "bi bi-people",
    },
    {
      id: 3,
      ...
      color: theme === "dark" ? "#ac3bceff" : "#a700a7",
      name: "bi bi-gear",
    },
    {
      id: 4,
      ...
      color: theme === "dark" ? "#429742ff" : "#0d6b0d",
      name: "bi bi-shield",
    },
    {
      id: 5,
      ...
      color: theme === "dark" ? "#e87d14ff" : "#ff7a00",
    ...
    },
    {
      ...
      color: theme === "dark" ? "#d15b71ff" : "#ed657d",
    ...
    <>
      ...
      <section className="Main2 p-5" style={{ backgroundColor: "#001b4c" }}>
        <div className="header mt-5 text-center d-flex flex-column align-items-center justify-content-center">
          ...
          <p
            className="fw-light text-center opacity-75 hearderText"
        ...
        <div
          className="responsive-grid mx-auto mt-2 py-3"
          style={{ width: "90%" }}
        >
          {gridMap.map((box) => (
            <div
