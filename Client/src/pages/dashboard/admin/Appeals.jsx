...
const MOCK_APPEALS = [
  {
    ...
    suspensionDetails: {
      reason:
        "Repeated submission of plagiarized code in Data Structures (CS301). Ignored two previous warnings.",
      appeal: {
        appealText:
          "I deeply apologize for my actions. I was overwhelmed with family issues and made a terrible decision to copy the assignment. I understand the severity of this and promise it will never happen again. Please allow me to submit my own work.",
      },
    },
  },
  {
    ...
    suspensionDetails: {
      reason:
        "Inappropriate and abusive language used in the assignment peer-review comments.",
      appeal: {
        appealText:
          "I am writing to sincerely apologize for my unprofessional behavior in the review section. I lost my temper over a misunderstanding. I have reached out to apologize to the student personally. I request you to restore my access.",
      },
    },
  },
];
    ...
    <div className="appeals-container fade-in position-relative">
      ...
      <div className="text-center mt-5 mb-4">
        ...
        <p className="fw-medium fs-6" style={{ color: "var(--text-muted)" }}>
          Review and process student appeals for account unsuspension.
        </p>
      </div>
      ...
      <div className="card bg-transparent px-4 px-md-5 border-0 pb-5">
        {appeals.length > 0 && (
          <div className="d-flex justify-content-between align-items-end mb-3 px-1">
            ...
            <span className="badge bg-danger bg-opacity-25 fw-semibold text-danger rounded-pill px-3 py-2">
              {appeals.length} Action(s) Required
            </span>
          </div>
        )}
                ...
                {appeals.length === 0 ? (
                  <tr>
                    <td colSpan="5" className="text-center py-5">
                      ...
                      >
                        The queue is empty. No pending appeals to review.
                      </p>
                    </td>
                  </tr>
                ) : (
                    ...
                    return (
                      <React.Fragment key={student._id}>
                        ...
                        <tr
                          ...
                          className={isExpanded ? "bg-light bg-opacity-10" : ""}
                        >
                          <td
                            className="ps-4"
                            style={{
                          ...
                          <td className="text-end text-primary fw-medium small pe-4">
                        ...
                        {isExpanded && (
                          <tr>
                            <td colSpan="5" className="p-0 border-0">
                              <div
                                className="px-4 py-4 border-start border-4 border-warning"
                              ...
                              >
                                <div className="row g-4 mb-4">
                                  ...
                                  <div className="col-md-5">
                                    ...
                                    <div
                                      className="p-3 bg-danger bg-opacity-10 border border-danger border-opacity-25 rounded-3 text-danger"
                                  ...
                                  <div className="col-md-7">
                                    ...
                                    <div
                                      className="p-3 rounded-3 shadow-sm fst-italic"
                                      style={{
                                        fontSize: "0.95rem",
                                        color: "var(--text-muted)",
                                    ...
                                    >
                                      "
                                      {
                                        student.suspensionDetails.appeal
                                          .appealText
                                      }
                                      "
                                    </div>
      ...
      {modalConfig.isOpen && (
        ...
        >
          ...
          >
            <div
              className={`p-4 py-3 border-bottom d-flex justify-content-between align-items-center ${modalConfig.type === "Approve" ? "bg-success bg-opacity-10 border-success border-opacity-25" : "bg-danger bg-opacity-10 border-danger border-opacity-25"}`}
            >
              <div className="d-flex align-items-center gap-3">
                <div
                  className={`rounded-circle d-flex align-items-center justify-content-center text-white ${modalConfig.type === "Approve" ? "bg-success" : "bg-danger"}`}
                ...
                <div>
                  <h5
                    className={`fw-bold mb-0 ${modalConfig.type === "Approve" ? "text-success" : "text-danger"}`}
                  >
              ...
              <button
                className={`btn btn-link p-0 ${modalConfig.type === "Approve" ? "text-success" : "text-danger"}`}
            ...
            <form onSubmit={handleProcessAppeal} className="p-4">
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  placeholder={
                    modalConfig.type === "Approve"
                      ? "e.g., Your appeal has been reviewed and accepted. Please ensure..."
                      : "e.g., Your appeal does not adequately address the policy violation..."
                  }
                  value={adminRemarks}
              ...
              <div className="d-flex justify-content-end gap-2">
                ...
                <button
                  type="submit"
                  className={`btn px-4 text-white fw-bold shadow-sm ${modalConfig.type === "Approve" ? "btn-success" : "btn-danger"}`}
