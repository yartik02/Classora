    ...
    <div className="fade-in" style={{ color: "var(--text-main)" }}>
      ...
      >
        <div className="d-flex align-items-center gap-4">
          ...
          <div>
            <h5 className="fw-bold mb-1">{MOCK_ADMIN_PROFILE.name}</h5>
            <p
              className="mb-0"
      ...
      <p className="small mt-4" style={{ color: "var(--text-muted)" }}>
...
const AcademicCycleTab = ({ onOpenTransitionModal }) => {
  ...
  return (
    <div className="fade-in" style={{ color: "var(--text-main)" }}>
      ...
      <h6
        className={`fw-bold text-danger mb-3 mt-5 d-flex align-items-center ${theme === "dark" ? "opacity-75" : ""}`}
        style={{
          fontSize: "0.85rem",
          textTransform: "uppercase",
          letterSpacing: "0.5px",
      ...
      <div
        className={`border border-danger${theme === "light" ? "-subtle" : ""} rounded-3 bg-danger bg-opacity-10 p-4`}
      >
        <div className="mb-3">
          <h6 className="fw-bold mb-1">Start New Semester</h6>
          <p className="small mb-0" style={{ color: "var(--text-muted)" }}>
  ...
  return (
    <div className="fade-in" style={{ color: "var(--text-main)" }}>
      <div
        ...
        style={{ borderBottom: "1px solid var(--text-muted)" }}
      >
        <h4 className="fw-bold mb-1">Global Policies</h4>
        <p className="small mb-0" style={{ color: "var(--text-muted)" }}>
      ...
      >
        ...
        >
          ...
          <div className="flex-shrink-0">
            <select
              className="form-select form-select-sm py-1 px-2 cursor-pointer shadow-none"
              style={{
                width: "90px",
                fontSize: "0.85rem",
                border: "1px solid var(--light-hover)",
        ...
        <div className="d-flex justify-content-between align-items-center p-4">
          <div>
            <h6
              className={`fw-bold mb-1 ${maintenance ? "text-warning" : ""}`}
  ...
  return (
    <div className="fade-in" style={{ color: "var(--text-main)" }}>
      <div
        ...
        style={{ borderBottom: "1px solid var(--text-muted)" }}
      >
        <h4 className="fw-bold mb-1">Appearance & Preferences</h4>
        <p className="small mb-0" style={{ color: "var(--text-muted)" }}>
      ...
      <div className="row g-3">
        ...
        <div className="col-12 col-md-4">
          <div
            ...
            className={`p-4 rounded-4 d-flex flex-column align-items-center justify-content-center transition-all ${themePreference === "light" ? "border-primary bg-primary bg-opacity-10 text-primary" : ""}`}
            style={{
              cursor: "pointer",
              backgroundColor: "var(--bg-surface)",
              color: "var(--text-muted)",
        ...
        <div className="col-12 col-md-4">
          <div
            ...
            className={`p-4 rounded-4 d-flex flex-column align-items-center justify-content-center transition-all ${themePreference === "dark" ? "border-primary bg-primary bg-opacity-10 text-primary" : ""}`}
            style={{
              cursor: "pointer",
              backgroundColor: "var(--bg-surface)",
              color: "var(--text-muted)",
        ...
        <div className="col-12 col-md-4">
          <div
            ...
            className={`p-4 rounded-4 d-flex flex-column align-items-center justify-content-center transition-all ${themePreference === "system" ? "border-primary bg-primary bg-opacity-10 text-primary" : ""}`}
            style={{
              cursor: "pointer",
              backgroundColor: "var(--bg-surface)",
              color: "var(--text-muted)",
...
const TransitionModal = ({ isOpen, onClose }) => {
  ...
  const handleExecute = (e) => {
    ...
    setTimeout(() => {
      onClose();
      toast.success(
        "Semester Transition executed successfully. The platform has been reset.",
      );
    }, 2500);
  };
        ...
        <div className="p-4">
          ...
          {step === 0 && (
            <div className="text-center py-5 fade-in">
              ...
              ></div>
              <h6 className="fw-bold">Checking Prerequisites...</h6>
              <p className="small mb-0" style={{ color: "var(--text-muted)" }}>
                Verifying all assignments and appeals are closed.
              </p>
            </div>
          )}
            ...
            <form onSubmit={handleNextStep} className="fade-in">
              <div className="d-flex align-items-center gap-2 text-success bg-success bg-opacity-10 p-2 px-3 rounded-2 border border-success border-opacity-25 mb-4">
                ...
                <span className="small fw-bold">
                  System Ready: 0 Pending Appeals, 0 Active Assignments.
                </span>
              </div>
              ...
              <div className="mb-4">
                <label
                  ...
                  style={{ letterSpacing: "0.5px", color: "var(--text-muted)" }}
                >
                  Acknowledgment
                </label>
                <div
                  className="d-flex flex-column gap-3 p-3 rounded-2"
                  style={{
                    backgroundColor: "var(--light-hover)",
                ...
                >
                  <label className="form-check d-flex align-items-start gap-2 mb-0 cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        setChecks({ ...checks, archive: e.target.checked })
                      }
                    />
                    <span className="small">
                      I understand that all active assignments will be
                  ...
                  <label className="form-check d-flex align-items-start gap-2 mb-0 cursor-pointer">
                    <input
                      className="form-check-input flex-shrink-0 mt-1"
                      type="checkbox"
                      checked={checks.allocations}
                      onChange={(e) =>
                        setChecks({ ...checks, allocations: e.target.checked })
                      }
                    />
                    <span className="small">
                      I understand that all faculty-to-class allocations will be
                      deleted.
                    </span>
                  </label>
                  <label className="form-check d-flex align-items-start gap-2 mb-0 cursor-pointer">
                    <input
                      className="form-check-input flex-shrink-0 mt-1"
                      type="checkbox"
                      checked={checks.alumni}
                      onChange={(e) =>
                        setChecks({ ...checks, alumni: e.target.checked })
                      }
                    />
                    <span className="small">
                      I understand that final-year students will be marked as
                      Alumni and lose portal access.
                    </span>
                  </label>
                </div>
              </div>
              ...
              <button
                type="submit"
                className="btn fw-bold w-100 py-2 btn-click-animation"
                style={{
                  backgroundColor: "var(--classora-accent-blue)",
            ...
            <form onSubmit={handleNextStep} className="fade-in">
              <div className="mb-4">
                ...
                <p
                  ...
                  style={{ color: "var(--text-muted)" }}
                >
                  To ensure this is intentional, please type{" "}
                  <span className="text-danger fw-bold user-select-all">
                    {EXPECTED_PHRASE}
                  </span>{" "}
                  below.
                </p>
                <input
                  ...
                  onPaste={(e) => {
                    e.preventDefault();
                    toast.warning(
                      "Pasting is disabled. Please type the phrase manually.",
                    );
                  }}
              ...
              <div className="d-flex gap-2">
                <button
                  type="button"
                  className="btn btn-light fw-medium px-4 border btn-click-animation"
                  onClick={() => setStep(1)}
                >
                  Back
                </button>
                <button
                  type="submit"
                  className="btn fw-bold flex-grow-1 btn-click-animation"
                  style={{
                    backgroundColor: "var(--classora-accent-blue)",
                    color: "var(--text-white)",
                  }}
            ...
            <form onSubmit={handleExecute} className="fade-in">
              <div className="mb-4" style={{ color: "var(--text-muted)" }}>
                ...
                <p className="small mb-3">
                  Enter your administrator password to authorize this
                  destructive action.
                </p>
                <input
                  type="password"
              ...
              <div className="d-flex gap-2">
                ...
                <button
                  type="submit"
                  className="btn btn-danger fw-bold flex-grow-1 d-flex justify-content-center align-items-center gap-2"
          ...
          {step === 4 && (
            <div className="text-center py-5 fade-in">
              ...
              <p className="small mb-0" style={{ color: "var(--text-muted)" }}>
                Archiving data and promoting students. Do not close this window.
              </p>
            </div>
          )}
        </div>
...
const AdminSettings = () => {
  ...
  return (
    <div className="settings-container fade-in pb-5">
      {/* HEADER */}
      ...
      <div className="card px-4 px-md-5 bg-transparent border-0">
        <div
          className="row m-0 rounded-4 overflow-hidden shadow-sm"
          style={{
          ...
          <div className="col-12 col-md-3 p-0 bg-secondary p-4 pe-0">
            <nav className="nav flex-column gap-1">
              {TABS.map((tab) => (
                <button
                  key={tab.id}
                  className={`btn text-start px-4 py-3 rounded-4 rounded-end-0 d-flex align-items-center gap-2 border-0 ${activeTab === tab.id ? "fw-bolder" : "bg-transparent fw-light hover-bg-light"} ${theme === "light" && activeTab === tab.id ? "text-dark" : "text-light"}`}
                  onClick={() => setActiveTab(tab.id)}
                  style={{
                    fontSize: "1rem",
                    backgroundColor:
                      activeTab === tab.id ? "var(--bg-main)" : "transparent",
                  }}
                >
                  <span
                    className={
      ...
      <TransitionModal
        key={isTransitionModalOpen ? "open" : "closed"}
